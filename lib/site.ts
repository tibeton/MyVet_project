...
export const site = {
  ...
  // ── Фото клиники ──────────────────────────────────────
  // Порядок совпадает с dict.clinic.items. Пустая строка = плитка-плейсхолдер.
  ...
  // Рейтинг и счётчик отзывов здесь больше не хранятся: вручную обновляемая
  // цифра устаревает молча и начинает врать. Кнопка ведёт на площадку, где
  // цифры всегда актуальные.
