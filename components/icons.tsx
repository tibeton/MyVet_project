...
// Зоогостиница — отдельный номер, а не общая клетка.
export function IconDoor(p: P) {
  return (
    <svg {...base} {...p}>
      <path d="M6 20.6V4.8a1.6 1.6 0 0 1 1.6-1.6h8.8a1.6 1.6 0 0 1 1.6 1.6v15.8" />
...
// Зоогостиница — вещи из дома: корм, лежанка, игрушки.
export function IconBag(p: P) {
  return (
    <svg {...base} {...p}>
      <rect x="3" y="7.6" width="18" height="12.6" rx="2.4" />
