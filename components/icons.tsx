...
export function IconTooth(p: P) {
  return (
    <svg {...base} {...p}>
      <path d="M12 3c-2.4 0-3 1.2-5 1.2C5 4.2 4 5.6 4 8c0 3 1 4.5 1.6 7.5C6 17.5 6.4 21 8 21c1.4 0 1.4-3 2-4.6.3-.8.6-1.4 2-1.4s1.7.6 2 1.4C16.6 18 16.6 21 18 21c1.6 0 2-3.5 2.4-5.5C21 12.5 22 11 22 8c0-2.4-1-3.8-3-3.8-2 0-2.6-1.2-5-1.2z" />
    </svg>
  );
}
